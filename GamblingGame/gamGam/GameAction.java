...
public class GameAction
{
    ...
    */
    ...
    public GameAction()
    {
	jointAction = new int[GamblingGame.NUM_AGENTS];
	...
	if( actions == null || 
	    actions.length != GamblingGame.NUM_AGENTS ) {
    ...
    {
	if( agent < 0 || agent >= GamblingGame.NUM_AGENTS ) {
    ...
    {
	System.out.print( "(" );
	for( int agent = 0; agent < GamblingGame.NUM_AGENTS-1; agent++ ) {
	    
	    System.out.print( ACTIONS_STRING[jointAction[agent]]+"," );
	}
	System.out.print( ACTIONS_STRING[jointAction[GamblingGame.NUM_AGENTS-1]] + ")" );
	System.out.println();
    }
