...
public class DCEQTransEqui extends DecenCEQTransEqui
{

    public DCEQTransEqui( int index )
    {
	/**
    ...
    public DCEQTransEqui( int index, double alpha, double gamma, double epsilon )
    {
