...
public class DecenCEQTransEqui extends DecenCEQ
{
    /**
     * the last game 
     */
    ...
    public DecenCEQTransEqui( int index )
    {
	super(index);
    ...
    public DecenCEQTransEqui( int index, double alpha, double gamma, double epsilon  )
    {
