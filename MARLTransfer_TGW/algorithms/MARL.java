...
public class MARL
{
    ...
    public static final int NASHQ_TransEqui = 11;
    public static final int NASHQ_SUPP_TRANS = 12;
    public static final int uCEQ_TransEqui = 13;
    public static final int eCEQ_TransEqui = 14;
    public static final int pCEQ_TransEqui = 15;
    public static final int dCEQ_TransEqui = 16;
    public static final int TeamQ = 17;
    public static final int NashQ_TransLocQ = 18;
    public static final int uCEQ_TransLocQ = 19;
    public static final int eCEQ_TransLocQ = 20;
    public static final int pCEQ_TransLocQ = 21;
    public static final int dCEQ_TransLocQ = 22;
    public static final int NEGOQ_TransLocQ = 23;
    public static final int NashQ_TransPolicy = 24;
    public static final int uCEQ_TransPolicy = 25;
    public static final int eCEQ_TransPolicy = 26;
    public static final int pCEQ_TransPolicy = 27;
    
    
    
    public static final String[] ALG_STRINGS = { "minimaxQ", "NashQ", "FFQ", "decCEQ", "cenCEQ", 
	"uCEQ", "eCEQ", "pCEQ", "dCEQ", "NegoQ", "WoLF-PHC", "NashQTransEqui", "NashQSuppTrans",
	"uCEQTransEqui", "eCEQTransEqui", "pCEQTransEqui", "dCEQTransEqui", "TeamQ", 
	"NashQTransLocQ", "uCEQTransLocQ","eCEQTransLocQ","pCEQTransLocQ",
	"dCEQTransLocQ", "NegoQTransLocQ",
	"NashQTransPolicy", "uCEQTransPolicy", "eCEQTransPolicy", "pCEQTransPolicy",};
     ...
     * 
     */
    protected double ALPHA = 0.2;//0.1
    protected double GAMMA = 0.9;//0.5;
    protected double EPSILON = 0.02;//0.04
	...
	if( gameAction == null || 
	    ...
	    System.out.println("@MARL->setQValue: Wrong Parameters!");
	    return;
	}
