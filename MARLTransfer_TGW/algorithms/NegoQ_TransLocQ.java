...
public class NegoQ_TransLocQ extends NegoQ
{

    public NegoQ_TransLocQ( int agIndex )
    {
	/**
    ...
    public NegoQ_TransLocQ( int agIndex, double alpha, double gamma, double epsilon )
    {
