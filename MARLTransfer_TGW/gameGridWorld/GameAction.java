...
public class GameAction
{
    ...
    */
    ...
    public GameAction()
    {
	jointAction = new int[GridWorld.NUM_AGENTS];
	...
	if( actions == null || 
	    actions.length != GridWorld.NUM_AGENTS ) {
    ...
    {
	System.out.print( "(" );
	for( int agent = 0; agent < GridWorld.NUM_AGENTS-1; agent++ ) {
	    
	    System.out.print( ACTIONS_STRING[jointAction[agent]]+"," );
	}
	System.out.print( ACTIONS_STRING[jointAction[GridWorld.NUM_AGENTS-1]] + ")" );
	System.out.println();
    }
