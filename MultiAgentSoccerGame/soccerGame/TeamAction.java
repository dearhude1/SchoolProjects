...
public class TeamAction
{
    ...
    public TeamAction()
    {
	teamAction = new int[SoccerGame.NUM_TEAM_AGENTS];
	
	for( int agent = 0; agent < SoccerGame.NUM_TEAM_AGENTS; agent++ )
	    teamAction[agent] = 0;
    }
	...
	if( actions == null || 
	    actions.length != SoccerGame.NUM_TEAM_AGENTS  ) {
    ...
    {
	if( agentNoInTeam < 0 || agentNoInTeam >= SoccerGame.NUM_TEAM_AGENTS ) {
