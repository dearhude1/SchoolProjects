...
public abstract class Controller<T> implements Runnable
{
	...
	//////////////////////////////////////////////////
	/**
	 * all these members are changed from private to protected
	 */
	protected boolean alive,wasSignalled,hasComputed;
	protected volatile boolean threadStillRunning;
	 ...
	 */
	/**
	 * dearhude1 changes this method, remove the original final limit of this method
	 */
