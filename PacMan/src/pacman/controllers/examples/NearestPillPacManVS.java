...
//					GameView.addLines(game,Color.RED,game.getPacmanCurrentNodeIndex(),game.getGhostCurrentNodeIndex(ghostType));
		...
		/**
		if(game.getGhostLairTime(GHOST.SUE)==0 && activePowerPills.length>0)
		{
			GameView.addPoints(game,Color.RED,game.getAStarPath(game.getGhostCurrentNodeIndex(GHOST.SUE),activePowerPills[0],MOVE.NEUTRAL));
			GameView.addPoints(game,Color.YELLOW,game.getAStarPath(game.getGhostCurrentNodeIndex(GHOST.SUE),activePowerPills[0],game.getGhostLastMoveMade(GHOST.SUE)));
		}
		*/
