...
public class GreedyGUCEQVFT extends GreedyGUCEQ {
	...
	public GreedyGUCEQVFT( Game game, boolean bLearn )
	{
		
		super(game, bLearn);
		
		
		valueFunctionFileName = "./valueFunction_GreedyGUCEQVFT_";
		if( !doesLearn ) {
	...
	public GreedyGUCEQVFT( Game game, double alpha, 
