...
public class PCEQLambda extends CEQLambda {
	
	public PCEQLambda( Game game, double lambda, boolean bLearn )
	{
		
		super(game, lambda, bLearn);
		
		valueFunctionFileName = "./valueFunction_pCEQLambda_";
	...
	public PCEQLambda( Game game, double alpha, 
			...
			ArrayList<int[]> gamingJointStrategies )
	{
		...
		return computeCE_plutocratic_Cplex(game, gamingGhosts, gamingJointStrategies);
	}
	
	private double[] computeCE_plutocratic_Cplex( Game game, 
