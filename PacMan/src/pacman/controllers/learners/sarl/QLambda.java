 ...
 *
 */
public class QLambda extends RLWithFA {

	
	/**
	 * for eligibility trace in Q(lambda)
	 */	
	protected HashMap<GHOST, double[][]> ghostEligMap = 
	...
	public QLambda( Game game, double lambda, boolean bLearn )
	{
		 ...
		 */
		valueFunctionFileName = "./valueFunction_QLambda_";
		if( !doesLearn )
			readValueFunction( valueFunctionFileName );
	}
	
	public QLambda( Game game, double alpha, 
