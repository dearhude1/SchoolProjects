...
public final class Constants
{
	...
	public enum MOVE 
	{
		...
		/**
		 * added by dearhude1, for transform from MOVE type to INT
		 */
		public static int parseMoves( MOVE moveType ) 
		{
			int retInt = -1;
			switch( moveType ) {
		...
		/**
		 * added by dearhude1, transform from INT to MOVE type
		 */
		public static MOVE parseInt( int move )
		{
			switch( move ) {
	 ...
	 * note that the MOVE neutral is not valid
	 */
	//public static final int NUM_GHOST_MOVES = 4;
	//public static final int NUM_PACMAN_MOVES = 5;
	public static final int NUM_REAL_MOVES = 4;
	

	public static final int NUM_GHOST_STRATEGIES_SINGLE_AGENT = 4;
	public static final int NUM_GHOST_STRATEGIES_MULTI_AGENT = 5;//4;//5;//6;//8;


	//the number of joint strategies
	public static final int NUM_JOINT_STRATEGIES = 625;//1296;//4096;
	
	public static final int NUM_FEATURES_SINGLE_AGENT = 17;
	public static final int NUM_FEATURES_MULTI_AGENT = 49;//41;//49;
	
	//////////////////////////////////////////
	/////////////Modified Strategies//////////
	//////////////////////////////////////////
	/**
	 * strategy 0: directly target to Ms. Pac-Man
	 */
	public static final int GHOST_STRATEGY_ATTACK = 0;
	/**
	 * strategy 1: run away from Ms. Pac-Man
	 */
	public static final int GHOST_STRATEGY_EVADE = 1;
	
	/**
	 * combine the original strategy PROTECT AND DEFEND
	 */
	public static final int GHOST_STRATEGY_POWERPILL = 2;
	
	/**
	 * strategy 2: target to the nearst Power Pill to Ms. Pac-Man
	 */
	//public static final int GHOST_STRATEGY_PROTECT = 2;
	/**
	 * strategy 3: target to the nearest Power Pill to this Ghost
	 */
	//public static final int GHOST_STRATEGY_DEFEND = 3;
	
	/**
	 * strategy 4: target to the hub nearest to Ms. Pac-Man 
	 * in its current direction
	 */
	//public static final int GHOST_STRATEGY_CUT = 4;
	/**
	 * strategy 5: target to the hub nearest to Ms. Pac-Man 
	 * in its reversal direction
	 */
	//public static final int GHOST_STRATEGY_BLOCK = 5;
	
	/**
	 * combine the original strategy COVER and FIND_COVER
	 */
	public static final int GHOST_STRATEGY_SHIELD = 3;
	/**
	 * strategy 6: cover the nearest edible ghost when not edible
	 */
	//public static final int GHOST_STRATEGY_COVER = 6;
	/**
	 * strategy 7: find a cover when edible
	 */
	//public static final int GHOST_STRATEGY_FINDCOVER = 7;
	
	/**
	 * NULL Strategy BUSY, denoting that the ghost cannot 
	 * take an action currently
	 * 
	 * STRATEGY BUSY has value, but cannot be taken
	 */
	public static final int GHOST_STRATEGY_BUSY = 4;
