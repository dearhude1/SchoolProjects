...
public class ECEQTransModel extends ECEQ
{
    ...
    public ECEQTransModel( double alpha, double gamma, double epsilon )
    {
	...
	transCndValues = new double[agentNum];
	transCndValues[0] = 13.0;//1.5;
	transCndValues[1] = 13.0;//2.0;
	...
	if( nextState == null ) {
		...
		ALPHA *= 0.9991;//0.995;//0.99985;//0.99;//0.99988;//58;//0.9975;//0.99958;
