...
public class ECEQTransPolicy extends ECEQ
{
     ...
     */
    double ETA = 1.0;//0.5;//1.0;//1.0;//0.5;//0.65;
    
    double ETA_decay = 0.9;//0.55;//0.65;0.88;
    ...
    public ECEQTransPolicy( double alpha, double gamma, double epsilon )
    {
