...
public class PCEQAbsGameNSR extends PCEQAbsGame
{
    ...
    public PCEQAbsGameNSR( double alpha, double gamma, double epsilon )
    {
	...
	for( int stateIndex = 0; stateIndex < allStates.size(); stateIndex++ ) {
		...
		if( klDis > maxKLDisArray[agIndex] / 200 ) {
