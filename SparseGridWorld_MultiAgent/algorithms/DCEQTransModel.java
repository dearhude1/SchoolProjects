...
public class DCEQTransModel extends DCEQ
{
    ...
    private double transferConditionValue = 15;//15;//50; //25;//0.05;
    ...
    public DCEQTransModel( int agIndex )
    {
	/**
    ...
    public DCEQTransModel( int agIndex, double alpha, double gamma, double epsilon )
    {
	...
	if( nextState == null ) {
		...
		ALPHA *= 0.9991;//0.998;//0.99988;//58;//0.9975;//0.99958;
