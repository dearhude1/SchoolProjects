...
public class ECEQTransLocQ extends ECEQ
{

    public ECEQTransLocQ()
    {
	/**
    ...
    public ECEQTransLocQ( double alpha, double gamma, double epsilon )
    {
    ...
    {
	double[][][] locQs = 
		new double[SparseGridWorld.NUM_AGENTS][SparseGridWorld.NUM_CELLS][GameAction.NUM_ACTIONS];
	try {
