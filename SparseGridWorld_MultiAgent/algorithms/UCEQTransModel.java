...
public class UCEQTransModel extends UCEQ
{
	...
	transCndValues[2] = 3.0;
	//transCndValues[3] = 1.5;
	...
	transCndValues = new double[agentNum];
	transCndValues[0] = 10;//1.5;
	transCndValues[1] = 10;//3.0;
	transCndValues[2] = 10;//3.0;
	transCndValues[3] = 10;//1.5;
    ...
    */
	...
	validCellsLists = new ArrayList[SparseGridWorld.NUM_AGENTS];
	for( int agent = 0; agent < SparseGridWorld.NUM_AGENTS; agent++ ) 
