...
import teamGamGam.StateActionPair;
...
public class MARL
{
    ...
    protected double EPSILON = 0.01;//0.8;//0.01;//0.1;//0.025;
    ...
    */
	...
	if( random.nextDouble() < EPSILON ) { 
	     ...
	     */
	    int[] newActions = new int[GamblingGame.NUM_TEAM_AGENTS];
		...
		for( int act = 0; act < GameAction.NUM_ACTIONS; act++ ) {
		    ...
		    proSum += 1.0 / GameAction.NUM_ACTIONS;
		    if( pro <= proSum ) {
