...
public class MARL
{
    ...
    public static final int NASHQ_SUPP_TRANS = 11;
    
    
    public static final String[] ALG_STRINGS = { "minimaxQ", "NashQ", "FFQ", "decCEQ", "cenCEQ", 
	"uCEQ", "eCEQ", "pCEQ", "dCEQ", "NegoQ", "WoLF-PHC", "NashQSuppTrans" };
	...
	Qs = new double[GridWorld.NUM_AGENTS][locNum][locNum][locNum][actionNum][actionNum][actionNum];
	...
	if( vstNum[loc0][loc1][loc2][a0][a1][a2] <= 0.0 )
	    ...
	    return 1 / vstNum[loc0][loc1][loc2][a0][a1][a2];
