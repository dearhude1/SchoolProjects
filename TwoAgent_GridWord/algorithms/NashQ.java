...
public class NashQ extends MARL
{
	...
	for( int agentIndex = 0; agentIndex < GridWorld.NUM_AGENTS; agentIndex++ )
		...
		for( int s2 = 0; s2 < locNum; s2++ )
			...
			for( int a2 = 0; a2 < actionNum; a2++ ) {
			    ...
			    Qs[agentIndex][s1][s2][a1][a2] = random.nextDouble();//(Math.random() - 0.5) / 10.0;
			}
    ...
    */
	...
	try {
	    ...
	    BufferedReader gameCountReader = new BufferedReader(new FileReader("./NashQ_gameCount.csv"));
	    ...
	    BufferedReader rateReader = new BufferedReader(new FileReader("./NashQ_rate.csv"));
	    index = 0;
	...
	try {
	    ...
	    BufferedWriter rateWriter = new BufferedWriter(new FileWriter("./NashQ_rate.csv"));
	    BufferedWriter gameCountWriter = new BufferedWriter(new FileWriter("./NashQ_gameCount.csv"));
