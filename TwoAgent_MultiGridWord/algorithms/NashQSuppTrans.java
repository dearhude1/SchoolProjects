...
public class NashQSuppTrans extends NashQ
{
	...
	/**/
	supportProfiles = new Support[locNum][locNum][MultiGridWorld.NUM_AGENTS];
	
	lastActions = new GameAction[locNum][locNum];
	lastEquilibrium = new double[locNum][locNum][MultiGridWorld.NUM_AGENTS * GameAction.NUM_ACTIONS];
	deltaQs = new double[MultiGridWorld.NUM_AGENTS][locNum][locNum][actionNum][actionNum];
