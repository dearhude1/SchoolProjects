...
public class GameAction
{
    ...
    */
    ...
    public GameAction()
    {
	jointAction = new int[MultiGridWorld.NUM_AGENTS];
	...
	if( actions == null || 
	    actions.length != MultiGridWorld.NUM_AGENTS ) {
    ...
    {
	System.out.print( "(" );
	for( int agent = 0; agent < MultiGridWorld.NUM_AGENTS-1; agent++ ) {
	    
	    System.out.print( ACTIONS_STRING[jointAction[agent]]+"," );
	}
	System.out.print( ACTIONS_STRING[jointAction[MultiGridWorld.NUM_AGENTS-1]] + ")" );
	System.out.println();
    }
