...
public class NegoQ extends MARL
{
    ...
    /**
     * compute the optimal action in a state
	...
	for( int act_j = 0; act_j < GameAction.NUM_ACTIONS; act_j++ ) {
	    ...
	    int agent_j = (agentIndex+1) % PursuitGame.NUM_AGENTS;
	...
	for( int act_j = 0; act_j < GameAction.NUM_ACTIONS; act_j++ ) {
	    ...
	    int agent_j = (agent_i+1) % PursuitGame.NUM_AGENTS;
	...
	else if( prefix.length != PursuitGame.NUM_AGENTS ) {
