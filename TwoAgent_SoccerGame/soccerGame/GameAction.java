...
public class GameAction
{
    ...
    */
    ...
    public static final String[] ACTIONS_STRING = { "R", "U", "L", "D", "S" };
    ...
    public GameAction()
    {
	jointAction = new int[SoccerGame.NUM_AGENTS];
	...
	if( actions == null || 
	    actions.length != SoccerGame.NUM_AGENTS ) {
    ...
    {
	System.out.print( "(" );
	for( int agent = 0; agent < SoccerGame.NUM_AGENTS-1; agent++ ) {
	    
	    System.out.print( ACTIONS_STRING[jointAction[agent]]+"," );
	}
	System.out.print( ACTIONS_STRING[jointAction[SoccerGame.NUM_AGENTS-1]] + ")" );
	System.out.println();
    }
